  ...
  >
    <Moon
      className={cn(
        ...
        "data-[state=chacked]:opacity-100 data-[state=unchacked]:opacity-0"
      )}
    />
    ...
    <Sun
      className={cn(
        "h-4 w-4 absolute z-[1000] top-[10px] right-[19px] stroke-gray-600 fill-white transition-opacity duration-300 ease-in-out",
        " data-[state=chacked]:opacity-0 data-[state=unchacked]:opacity-100"
      )}
    />
  </SwitchPrimitives.Root>
));
